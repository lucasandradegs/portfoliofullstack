...
const Register = function() {
    ...
    const handleRegister = async (event: FormEvent<HTMLFormElement>)=> {
        ...
        if(password != confirmPassword){
            ...
            setToastMessage("Senha e confirmação de senha não coincidem!")
    ...
    return (<>
    <Head>
        <title>Registre-se no meu Portfólio</title>
    ...
    <main className={styles.main}>
        ...
        <Container className="py-5">
            <p className={styles.formTitle}><strong>Bem vindo(a) ao meu Portfólio!</strong></p>
            <Form className={styles.form} onSubmit={handleRegister}>
                ...
                <FormGroup>
                    ...
                    name="password" 
                    type="password" 
                    placeholder="Digite a sua senha (Min: 6 caracteres / Max: 20 caracteres)"
                    required
                    minLength={6}
                    maxLength={20}
                    className={styles.input}
